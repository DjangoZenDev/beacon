"""Beacon v0.8 — Serializers (carried from Ch7)."""
...
class PageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Page
        fields = ["id","organization_id","title","slug","body","author","author_username","incoming_count","outgoing_count","outgoing_links","incoming_links","created_at","updated_at"]
...
class PageListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Page
        fields = ["id","organization_id","title","slug","author","author_username","incoming_count","outgoing_count","updated_at"]
