"""
Beacon v0.16 — Core Models. Principle 1: Start Simple.

Two models. Page + PageLink. The wikilink graph is computed at write time.
This is Beacon's core insight: knowledge is a graph, not a folder hierarchy.
"""
import re
