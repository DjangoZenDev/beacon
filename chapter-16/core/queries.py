"""
Beacon v0.16 — Scatter-Gather Queries. Principle 6: Shard by Tenant.

Search is parallelized across all shards via ThreadPoolExecutor.
Results are merged and ranked by backlink count.
"""
