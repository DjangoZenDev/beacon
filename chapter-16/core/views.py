"""
Beacon v0.16 — Views. All 22 Principles in Action.

The final form: class-based views with DRF API, CDN invalidation,
shard-aware queries, and Prometheus metrics.
"""
