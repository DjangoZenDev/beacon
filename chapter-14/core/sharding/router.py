"""Beacon v0.14 — Shard Router, DualWrite, Backfill."""
# router.py
import logging, threading
from django.conf import settings
from .ring_manager import ring_manager
logger = logging.getLogger("beacon.sharding"); _tl = threading.local()
...
class OrganizationShardRouter:
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints): return db == "default" or db in getattr(settings,"SHARD_MAP",{})
