...
"""Beacon v0.14 — Search Service: Kafka Consumer."""
import json, logging
...
def main():
    ...
    logger.info("Search service consumer started")
    for message in consumer:
        try: payload = message.value; indexer.handle_event(payload.get("type","unknown"), payload.get("payload",{}))
