...
"""Beacon v0.9 — Org Shard Router (carried from Ch6)."""
...
class OrganizationShardRouter:
    ...
    def allow_relation(self, obj1, obj2, **hints):
        o1 = self._org_id(obj1)
        o2 = self._org_id(obj2)
    ...
    def _resolve(self, model, **hints):
        ...
        if org_id is None and "instance" in hints:
            org_id = self._org_id(hints["instance"])
        if org_id is None:
            return None
        try:
