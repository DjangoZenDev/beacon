...
"""Beacon v0.13 — Core Models. Carried forward from Ch9, Ch10, Ch11, Ch12.

Chapter 13: Models unchanged from multi-region deployment — CockroachDB
handles cross-region replication at the database layer.
"""
...
class Page(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        try:
            ...
            enqueue_outbox("beacon.events.pages", {
                "type": event_type,
                "payload": {"page_id": self.pk, "organization_id": self.organization_id,
    ...
    def delete(self, *args, **kwargs):
        ...
        try:
            ...
            enqueue_outbox("beacon.events.pages", {
                "type": "page.deleted",
                "payload": {"page_id": pk, "organization_id": org_id},
            })
        except Exception:
            pass
