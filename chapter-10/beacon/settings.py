"""Beacon v0.10 settings — Chapter 10: Elasticsearch Search."""

import os
from pathlib import Path

BASE_DIR = Path(__file__).resolve().parent.parent
SECRET_KEY = "django-insecure-beacon-ch10-dev-key-change-in-production"
DEBUG = False
ALLOWED_HOSTS = ["*"]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "beacon.replication": {"handlers": ["console"], "level": "INFO", "propagate": False},
        ...
        "beacon.search": {"handlers": ["console"], "level": "INFO", "propagate": False},
        "beacon.indexer": {"handlers": ["console"], "level": "INFO", "propagate": False},
    },
}
